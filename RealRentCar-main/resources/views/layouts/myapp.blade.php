            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/Mohiuddin-Islam" class="hover:underline "
                                        target='_blank'>Github</a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/mohiuddinislam.sonet/" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2024 <a
                            href="#" target='_blank'
                            class="hover:underline">Mohiuddin.Islam™</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/Mohiuddin-Islam" target='_blank'
                        ...
                        <a href="https://www.instagram.com/mohiuddinislam.sonet/" target='_blank'
                            class="text-gray-500  hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
